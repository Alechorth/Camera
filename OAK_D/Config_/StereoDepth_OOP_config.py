...
def DepthMap2lidar(frame, density = 1000, treshold = 50, danger_value = 200):
...
with dai.Device(stream.pipeline) as device:
    ...
    while True:
        ...
        frame = (frame * (255 / stream.stereo.initialConfig.getMaxDisparity())).astype(np.uint8)
        DepthMap2lidar(frame)
