...
while True:
    ...
    if len(corners) > 0:
        for i in range(0, len(ids)):
            ...
            cv2.putText(frame, str_position, (0, (base_position)+(i*250)), font, 1, (0, 255, 0), 2, cv2.LINE_AA)
            ...
            cv2.putText(frame, str_attitude, (0, (base_position + 50)+(i*250)), font, 1, (0, 255, 0), 2, cv2.LINE_AA)
            ...
            cv2.putText(frame, str_position, (0, (base_position + 100)+(i*250)), font, 1, (0, 255, 0), 2, cv2.LINE_AA)
            ...
            cv2.putText(frame, str_attitude, (0, (base_position + 150)+(i*250)), font, 1, (0, 255, 0), 2, cv2.LINE_AA)
