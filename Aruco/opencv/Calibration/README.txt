...
execute the cameracalib.py by calling: cameracalib.py  <folder> <image type> <num rows> <num cols> <cell dimension>
 ...
 - num rows: the number of rows of the checker board 9
 - num cols: the number of columns of the checker board 6
 - cell dimension: the physical dimension of a cell side in mm 23.66
